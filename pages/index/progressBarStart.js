 ...
 * @param {boolean} isRefund  是否减少
 */
function pureCricle(pbObj /*参数集*/, eqNum /*当前百分值*/, stopAngle /*扇形角度*/, isRefund = false /*是否减少*/) {

    let barcolor = isRefund ? pbObj.bgcolor : pbObj.barcolor;
